...
export default class MuslimCodicil extends Component {
    ...
    componentDidMount() {
        ...
        .then((response) => {
            ...
            // step 11
            this.setState({otherTransferBeneficiary: will.otherTransferBeneficiary});
    ...
    updateAndClose = (e, postStatus) => {
        ...
        if (form.checkValidity() === false) {
            ...
            // step 5
            formData.append("otherFamilyMembers", JSON.stringify(this.state.otherFamilyMembers));
    
            // step 6
            formData.append("guardianDetails", JSON.stringify(this.state.guardianDetails));
    
            // step 7
            formData.append("executorDetails", JSON.stringify(this.state.executorDetails));
            ...
            // step 8
            formData.append("beneficiaryAssets", JSON.stringify(this.state.beneficiaryAssets));
            ...
            // step 11
            formData.append("otherTransferBeneficiary", this.state.otherTransferBeneficiary);
            ...
            // step 14
            formData.append("additionalInstructions", JSON.stringify(this.state.additionalInstructions));
            ...
            // step 15
            formData.append("signingDetails", JSON.stringify(this.state.signingDetails));
            
            formData.append("userID", localStorage.getItem("id"));
            formData.append("willID", parseURLParams(window.location.href).will_id[0]);

            axios.post(process.env.REACT_APP_API_URL + '/managewill/updateWill_muslim', formData)
            .then((response) => {
    ...
    render() {
        ...
        switch (step) {
            case 1:
                return(
                    <Step1MuslimCodicil updateAndClose={this.updateAndClose} nextStep={this.nextStep} prevStep={this.prevStep} handleChange={this.handleChange} changeState={this.changeState} values={values} />
                )  
            case 2:
                return(
                    <Step2MuslimCodicil updateAndClose={this.updateAndClose} nextStep={this.nextStep} prevStep={this.prevStep} handleChange={this.handleChange} changeState={this.changeState} values={values} />
                )
            case 3:
                return(
                    <Step4MuslimCodicil updateAndClose={this.updateAndClose} nextStep={this.nextStep} prevStep={this.prevStep} handleChange={this.handleChange} changeState={this.changeState} values={values} />
                )    
                
            case 4:
                return(
                    <Step5MuslimCodicil updateAndClose={this.updateAndClose} nextStep={this.nextStep} prevStep={this.prevStep} handleChange={this.handleChange} changeState={this.changeState} values={values} />
                )
            case 5:
                return(
                    <Step6MuslimCodicil updateAndClose={this.updateAndClose} nextStep={this.nextStep} prevStep={this.prevStep} handleChange={this.handleChange} changeState={this.changeState} values={values} />
                )
            case 6:
                return(
                    <Step7MuslimCodicil updateAndClose={this.updateAndClose} nextStep={this.nextStep} prevStep={this.prevStep} handleChange={this.handleChange} changeState={this.changeState} values={values} />
                )
            case 7:
                return(
                    <Step8MuslimCodicil updateAndClose={this.updateAndClose} nextStep={this.nextStep} prevStep={this.prevStep} handleChange={this.handleChange} changeState={this.changeState} values={values} />
                )
            case 8:
                return(
                    <Step10MuslimCodicil updateAndClose={this.updateAndClose} nextStep={this.nextStep} prevStep={this.prevStep} handleChange={this.handleChange} changeState={this.changeState} values={values} />
                )
            case 9:
                return(
                    <Step11MuslimCodicil updateAndClose={this.updateAndClose} nextStep={this.nextStep} prevStep={this.prevStep} handleChange={this.handleChange} changeState={this.changeState} values={values} />
                )
            case 10:
                return(
                    <Step12MuslimCodicil updateAndClose={this.updateAndClose} nextStep={this.nextStep} prevStep={this.prevStep} handleChange={this.handleChange} changeState={this.changeState} values={values} />
                )
            case 11:
                return(
                    <Step13MuslimCodicil updateAndClose={this.updateAndClose} nextStep={this.nextStep} prevStep={this.prevStep} handleChange={this.handleChange} changeState={this.changeState} values={values} />
                )
            case 12:
                return(
                    <Step14MuslimCodicil updateAndClose={this.updateAndClose} nextStep={this.nextStep} prevStep={this.prevStep} handleChange={this.handleChange} changeState={this.changeState} values={values} />
                )
            case 13:
                return(
                    <Step15MuslimCodicil updateAndClose={this.updateAndClose} nextStep={this.nextStep} prevStep={this.prevStep} handleChange={this.handleChange} changeState={this.changeState} values={values} />
                )
