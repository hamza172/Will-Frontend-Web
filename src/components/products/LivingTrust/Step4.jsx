          ...
          <div>
            ...
            {values.step4Gifts[i].assetType === "Real Estate" && (
              <div>
                ...
                <Form.Group>
                  ...
                  <Form.Control
                    value={values.step4Gifts[i].realEstateType}
                    type="text"
                    onChange={(e) => {
            ...
            {values.step4Gifts[i].assetType === "Financial Account" && (
              <div>
                ...
                <Form.Group>
                  ...
                  <Form.Control
                    value={values.step4Gifts[i].financialAccountName}
                    type="text"
                    onChange={(e) => {
                      values.step4Gifts[i].financialAccountName =
                        e.target.value;
                ...
                <Form.Group>
                  ...
                  <Form.Control
                    value={values.step4Gifts[i].financialAccountType}
                    type="text"
                    onChange={(e) => {
                      values.step4Gifts[i].financialAccountType =
                        e.target.value;
                ...
                <Form.Group>
                  ...
                  <Form.Control
                    value={values.step4Gifts[i].financialAccountNumber}
                    type="text"
                    onChange={(e) => {
                      values.step4Gifts[i].financialAccountNumber =
                        e.target.value;
            ...
            {values.step4Gifts[i].assetType ===
              ...
              <div>
                ...
                <Form.Group>
                  ...
                  <Form.Control
                    value={values.step4Gifts[i].stockAndBondStockName}
                    type="text"
                    onChange={(e) => {
                      values.step4Gifts[i].stockAndBondStockName =
                        e.target.value;
                ...
                <Form.Group>
                  ...
                  <Form.Control
                    value={values.step4Gifts[i].stockAndBondStockNumberOfShares}
                    type="text"
                    onChange={(e) => {
                      values.step4Gifts[i].stockAndBondStockNumberOfShares =
                        e.target.value;
                      changeState(
                        values.step4Gifts[i].stockAndBondStockNumberOfShares
                      );
                ...
                <Form.Group>
                  ...
                  <Form.Control
                    value={
                      values.step4Gifts[i].stockAndBondStockCertificateNumber
                    }
                    type="text"
                    onChange={(e) => {
                      values.step4Gifts[i].stockAndBondStockCertificateNumber =
                ...
                <Form.Group>
                  ...
                  <Form.Control
                    value={values.step4Gifts[i].stockAndBondStockDescription}
                    type="text"
                    onChange={(e) => {
                      values.step4Gifts[i].stockAndBondStockDescription =
                        e.target.value;
                      changeState(
                        values.step4Gifts[i].stockAndBondStockDescription
                      );
                ...
                <Form.Group>
                  ...
                  <Form.Control
                    value={values.step4Gifts[i].stockAndBondBondName}
                    type="text"
                    onChange={(e) => {
                      values.step4Gifts[i].stockAndBondBondName =
                        e.target.value;
                ...
                <Form.Group>
                  ...
                  <Form.Control
                    value={values.step4Gifts[i].stockAndBondBondValue}
                    type="text"
                    onChange={(e) => {
                      values.step4Gifts[i].stockAndBondBondValue =
                        e.target.value;
                ...
                <Form.Group>
                  ...
                  <Form.Control
                    value={
                      values.step4Gifts[i].stockAndBondBondCertificateNumber
                    }
                    type="text"
                    onChange={(e) => {
                      values.step4Gifts[i].stockAndBondBondCertificateNumber =
                ...
                <Form.Group>
                  ...
                  <Form.Control
                    value={values.step4Gifts[i].stockAndBondBondDescription}
                    type="text"
                    onChange={(e) => {
                      values.step4Gifts[i].stockAndBondBondDescription =
                        e.target.value;
                      changeState(
                        values.step4Gifts[i].stockAndBondBondDescription
                      );
            ...
            {values.step4Gifts[i].assetType === "Business Interest" && (
              <div>
                ...
                <Form.Group>
                  ...
                  <Form.Control
                    value={values.step4Gifts[i].businessName}
                    type="text"
                    onChange={(e) => {
                ...
                <Form.Group>
                  ...
                  <Form.Control
                    value={values.step4Gifts[i].businessDescription}
                    type="text"
                    onChange={(e) => {
            ...
            {values.step4Gifts[i].assetType === "Contractual Interest" && (
              <div>
                ...
                <Form.Group>
                  ...
                  <Form.Control
                    value={values.step4Gifts[i].titleOfContract}
                    type="text"
                    onChange={(e) => {
                ...
                <Form.Group>
                  ...
                  <Form.Control
                    value={values.step4Gifts[i].nameOfOtherParty}
                    type="text"
                    onChange={(e) => {
                ...
                <Form.Group>
                  ...
                  <Form.Control
                    value={values.step4Gifts[i].dateOfContract}
                    type="text"
                    onChange={(e) => {
                ...
                <Form.Group>
                  ...
                  <Form.Control
                    value={values.step4Gifts[i].contarctDescription}
                    type="text"
                    onChange={(e) => {
            ...
            {values.step4Gifts[i].assetType === "Life Assurance Proceed" && (
              <div>
                ...
                <Form.Group>
                  ...
                  <Form.Control
                    value={values.step4Gifts[i].lifeAssuranceName}
                    type="text"
                    onChange={(e) => {
                ...
                <Form.Group>
                  ...
                  <Form.Control
                    value={values.step4Gifts[i].lifeAssuranceDescription}
                    type="text"
                    onChange={(e) => {
                      values.step4Gifts[i].lifeAssuranceDescription =
                        e.target.value;
                      changeState(
                        values.step4Gifts[i].lifeAssuranceDescription
                      );
                ...
                <Form.Group>
                  ...
                  <Form.Control
                    value={values.step4Gifts[i].lifeAssuranceNumber}
                    type="text"
                    onChange={(e) => {
            ...
            {values.step4Gifts[i].assetType === "Retirement Proceed" && (
              <div>
                ...
                <Form.Group>
                  <Form.Label>Name of Issuer</Form.Label>
                  <Form.Control
                    value={values.step4Gifts[i].retirementProceedName}
                    type="text"
                    onChange={(e) => {
                      values.step4Gifts[i].retirementProceedName =
                        e.target.value;
                ...
                <Form.Group>
                  <Form.Label>Description of Policy</Form.Label>
                  <Form.Control
                    value={values.step4Gifts[i].retirementProceedDescription}
                    type="text"
                    onChange={(e) => {
                      values.step4Gifts[i].retirementProceedDescription =
                        e.target.value;
                      changeState(
                        values.step4Gifts[i].retirementProceedDescription
                      );
                ...
                <Form.Group>
                  <Form.Label>Policy Number</Form.Label>
                  <Form.Control
                    value={values.step4Gifts[i].retirementProceedNumber}
                    type="text"
                    onChange={(e) => {
                      values.step4Gifts[i].retirementProceedNumber =
                        e.target.value;
            ...
            {values.step4Gifts[i].assetType === "Personal Possession" && (
              <div>
                ...
                <Form.Group>
                  <Form.Label>
                    Do you want to place all your Personal Possession in the
                    Trust ?
                  </Form.Label>
                  <select
                    className="form-control"
                    value={values.step4Gifts[i].personalPropertyQuestion}
                    onChange={(e) => {
                      values.step4Gifts[i].personalPropertyQuestion =
                        e.target.value;
                      changeState(
                        values.step4Gifts[i].personalPropertyQuestion
                      );
                ...
                {values.step4Gifts[i].personalPropertyQuestion === "No" && (
                  <Form.Group>
                    ...
                    <Form.Control
                      value={values.step4Gifts[i].personalPropertyDescription}
                      type="text"
                      onChange={(e) => {
                        values.step4Gifts[i].personalPropertyDescription =
                          e.target.value;
                        changeState(
                          values.step4Gifts[i].personalPropertyDescription
                        );
