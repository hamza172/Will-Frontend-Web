  ...
  return (
    <FormContainer>
      ...
      >
        ...
        include Husbands/Wives/Spouses, Sons, Daughters, Sister, Brothers, Grand
        Father, Grand Mother, Uncles that is entitled to your estate according
        to Islamic law. Please note Will be shared to your family according to
        Islamic right. Please click the{" "}
        <span style={{ cursor: "pointer", color: "blue" }}>“Schedule A”</span>{" "}
        to understand Islamic sharing formula.
      </Form.Label>
      <h4 className="mb-5"> Step 3: Wives and Family Members for Wasiyah</h4>
