    ...
    <FormContainer>
      ...
      <Form noValidate validated={validated} onSubmit={submitHandler}>
        ...
        <Form.Group controlId="giftToPet">
          ...
          <Form.Control required as="select" value={giftToPet} onChange={handleChange}>
        ...
        {showFields && (
          <>
            ...
            <Form.Group controlId="description">
              ...
              <Form.Control type="text" as="textarea" rows={5} required placeholder="Enter Description" value={description} onChange={(e) => setDescription(e.target.value)}></Form.Control>
              <Form.Control.Feedback type="invalid">Please fill the required field.</Form.Control.Feedback>
            </Form.Group>

            <Form.Group controlId="amount">
              <Form.Label>Amount</Form.Label>
              <Form.Control type="number" required placeholder="Enter Amount" value={amount} onChange={(e) => setAmount(e.target.value)}></Form.Control>
              <Form.Control.Feedback type="invalid">Please fill the required field.</Form.Control.Feedback>
            </Form.Group>
          </>
        )}
        ...
        <Form.Group controlId="caretaker">
          ...
          <Form.Control required as="select" value={caretaker} onChange={handleChange1}>
        ...
        {showFields1 && (
          <>
            ...
            <Form.Group controlId="careTakerName">
              ...
              <Form.Control required type="text" placeholder="Enter CareTaker Name" value={careTakerName} onChange={(e) => setCareTakerName(e.target.value)}></Form.Control>
              <Form.Control.Feedback type="invalid">Please fill the required field.</Form.Control.Feedback>
            </Form.Group>

            <Form.Group controlId="address">
              <Form.Label>Address</Form.Label>
              <Form.Control required type="text" placeholder="Enter Address" value={address} onChange={(e) => setAdd(e.target.value)}></Form.Control>
              <Form.Control.Feedback type="invalid">Please fill the required field.</Form.Control.Feedback>
            </Form.Group>
          </>
        )}
