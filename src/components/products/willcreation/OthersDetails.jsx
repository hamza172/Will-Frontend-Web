    ...
    <FormContainer>
      ...
      <Form noValidate validated={validated} onSubmit={submitHandler}>
        ...
        <Form.Group controlId="transferBeneficiary">
          ...
          <Form.Control required as="select" value={transferBeneficiary} onChange={(e) => setBeneficiary(e.target.value)}>
        ...
        <Form.Group controlId="giftMadeTo">
          ...
          <Form.Control required as="select" value={giftMadeTo} onChange={handleChange}>
            <option disabled selected value="">[Please select one]</option>
        ...
        {showFields && (
          <>
            <Form.Group controlId="trusteeName">
              ...
              <Form.Control required type="text" placeholder="Enter Trustee Full Name" value={trusteeName} onChange={(e) => setTrusteeName(e.target.value)}></Form.Control>
            ...
            <Form.Group controlId="trusteeAdd">
              ...
              <Form.Control type="text" required placeholder="Enter Address" value={trusteeAdd} onChange={(e) => setTrusteeAdd(e.target.value)}></Form.Control>
              <Form.Control.Feedback type="invalid">Please fill the required field.</Form.Control.Feedback>
            </Form.Group>
          </>
        )}
        ...
        <Form.Group controlId="relationship">
          ...
          <Form.Control required type="text" placeholder="Enter Relationship" value={relationship} onChange={(e) => setRelationship(e.target.value)}></Form.Control>
          <Form.Control.Feedback type="invalid">Please fill the required field.</Form.Control.Feedback>
        </Form.Group>
        ...
        <Form.Group controlId="contest">
          ...
          <Form.Control required as="select" value={contest} onChange={(e) => setContest(e.target.value)}>
            <option disabled selected value="">[Please select one]</option>
