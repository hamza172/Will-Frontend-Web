...
const Step3NonMuslim = ({values, nextStep, prevStep, handleChange, changeState}) => {
                ...
                {[...Array(values.step3ExecutorDetails.length)].map((e, i) => 
                    <div key={i + 1}>
                        ...
                        <Form.Group controlId="name">
                            ...
                            <Form.Control type="text" name="name" value={values.step3ExecutorDetails[i].name} onChange={(e) => {
                        ...
                        <Form.Group controlId="relationship">
                            ...
                            <Form.Control as="select" name="relationship" value={values.step3ExecutorDetails[i].relationship} onChange={(e) => {
                        ...
                        <Form.Group controlId="address">
                            ...
                            <Form.Control type="text" name="address" value={values.step3ExecutorDetails[i].address} onChange={(e) => {
                        ...
                        <Form.Group controlId="town">
                            ...
                            <Form.Control type="text" name="town" value={values.step3ExecutorDetails[i].town} onChange={(e) => {
                        ...
                        <Form.Group controlId="state">
                            ...
                            <Form.Control type="text" name="state" value={values.step3ExecutorDetails[i].state} onChange={(e) => {
                        ...
                        <Form.Group controlId="email">
                            ...
                            <Form.Control type="text" name="email" value={values.step3ExecutorDetails[i].email} onChange={(e) => {
                        ...
                        <Form.Group controlId="ph">
                            ...
                            <Form.Control type="text" name="ph" value={values.step3ExecutorDetails[i].phoneNumber} onChange={(e) => {
                        ...
                        <Form.Group controlId="isRenumerated">
                            ...
                            <Form.Control as="select" name="isRenumerated" value={values.step3ExecutorDetails[i].willExecutorBeRenumerated} onChange={(e) => {
                                values.step3ExecutorDetails[i].willExecutorBeRenumerated = e.target.value;
                                changeState(values.step3ExecutorDetails[i].willExecutorBeRenumerated);  
                            }}>
                        ...
                        {values.step3ExecutorDetails[i].willExecutorBeRenumerated === "Yes" &&
                        <Form.Group controlId="execRenumeration">
                            <Form.Label>Executor Renumeration</Form.Label>
                            <Form.Control type="text" name="execRenumeration" value={values.step3ExecutorDetails[i].executorRenumeration} onChange={(e) => {
                                values.step3ExecutorDetails[i].executorRenumeration = e.target.value;
                                changeState(values.step3ExecutorDetails[i].executorRenumeration);
                            }}></Form.Control>
                        </Form.Group>
                        }

                        <hr style={{marginBottom: "3rem", marginTop: "3rem", border: "1px solid #000"}}></hr>
                    </div>
                )}   


                <Button className="mr-3" color="primary" variant="contained" onClick={(e) => {
                    e.preventDefault();
