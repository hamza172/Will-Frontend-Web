        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <ul class="social-icons">
              <li><a class="facebook" href="#"><FaSearch /></a></li>
              <li><a class="twitter" href="#"><FaSearch /></a></li>
              <li><a class="dribbble" href="#"><FaSearch /></a></li>
              <li><a class="linkedin" href="#"><FaSearch /></a></li>   
            </ul>
          </div>
        </div>
      </div>
